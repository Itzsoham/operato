...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // SameSite=Lax added to shadcn's generated writer — browsers now warn on cookies
      // set without it. The value is non-sensitive UI state, so this is hygiene, not a fix.
